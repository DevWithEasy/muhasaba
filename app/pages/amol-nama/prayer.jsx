...
import DailyPayerStatics from "../../../components/prayer/DailyPayerStatics";
...
export default function Prayer() {
    ...
    const checkFiles = async () => {
      try {
        ...
        setUser(filesData.user || {});
        setSalah(filesData.salah || []);
      } catch (err) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <DailyPayerStatics user={user} salah={salah}/>
