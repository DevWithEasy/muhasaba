...
export default function AskLocation() {
  ...
  const getLocationPermission = async () => {
    ...
    try {
      ...
      Alert.alert("ত্রুটি", "অবস্থান পাওয়া যায়নি। দয়া করে আবার চেষ্টা করুন।");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleContinue = async () => {
    if (location) {
      ...
      Alert.alert("অবস্থান প্রয়োজন", "চালিয়ে যেতে দয়া করে অবস্থান চালু করুন");
    }
  };
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoText}>
              আপনার নামাজের সময় সঠিকভাবে দেখানোর জন্য, আমাদের আপনার বর্তমান অবস্থান
              জানতে হবে।
            </Text>
          ...
          {location && (
            <>
              <View style={styles.addressCard}>
                ...
                <Text style={styles.addressText}>{getAddressString(address)}</Text>
              </View>
