  ...
  return (
    ...
    >
      <View style={styles.mainContent}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>সঠিক তথ্য প্রদান করলে সঠিক ফলাফল পাবেন</Text>
          </View>
          ...
          <View style={styles.formContainer}>
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                <Ionicons name="person-outline" size={20} color="#037764" style={styles.icon} />
                <TextInput
                  style={styles.input}
                  value={name}
            ...
            <View style={styles.inputGroup}>
              ...
              >
                <View style={styles.dateContainer}>
                  <Ionicons name="calendar-outline" size={20} color="#037764" style={styles.icon} />
            ...
            {age !== null && (
              <View style={styles.ageContainer}>
                <Text style={styles.ageText}>আপনার বর্তমান বয়স: <Text style={styles.ageHighlight}>{age} বছর</Text></Text>
              </View>
            )}
          </View>
        </ScrollView>
      ...
      <View style={styles.footer}>
        <TouchableOpacity 
          style={[styles.button, (age === null || !name.trim()) && styles.disabledButton]}
